...
const SCHOOL_LEVEL: SchoolLevel = 'elementary';
const PAGE_TITLE = '초등학교 전쟁';
...
export default function ElementaryPage() {
  ...
  async function fetchSchoolRankings() {
    ...
    try {
      let url = `${API_BASE}/schools/ranking/${schoolRankingType}?limit=1000`;
  ...
  async function fetchStudentRankings() {
    ...
    try {
      let url = `${API_BASE}/users/ranking/${studentRankingType}?limit=1000`;
                  ...
                  return (
                    <>
                      <div className="text-sm text-gray-600 mb-4">
                        총 <span className="font-bold text-orange-600">{filteredSchools.length}개</span> 학교
              ...
              <div>
                {(() => {
                  ...
                  return (
                    <>
                      <div className="text-sm text-gray-600 mb-4">
                        총 <span className="font-bold text-orange-600">{filteredStudents.length}명</span> 학생
