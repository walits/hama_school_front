...
const SCHOOL_LEVEL: SchoolLevel = 'middle';
const PAGE_TITLE = '중학교 전쟁';
...
export default function MiddlePage() {
  ...
  async function fetchSchoolRankings() {
    ...
    try {
      let url = `${API_BASE}/mid-schools/ranking/${schoolRankingType}?limit=1000`;
  ...
  async function fetchStudentRankings() {
    ...
    try {
      let url = `${API_BASE}/mid-users/ranking/${studentRankingType}?limit=1000`;
          ...
          <div className="flex h-16 items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-blue-600 font-semibold -mt-1">{PAGE_TITLE}</div>
              </div>
            </Link>
        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex gap-3 self-start sm:self-auto flex-wrap">
            <a
              ...
              className="flex items-center gap-3 rounded-2xl bg-black px-5 py-3 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all"
            >
              ...
              <div className="text-left">
                ...
                <div className="text-sm font-bold leading-tight">중학교 전쟁 앱</div>
              </div>
            </a>
            <a
            ...
            >
              ...
              <div className="text-left">
                <div className="text-xs text-gray-300 leading-none">App Store에서 받기</div>
                <div className="text-sm font-bold leading-tight">중학교 전쟁 앱</div>
              </div>
            </a>
          </div>
                  ...
                  return (
                    <>
                      <div className="text-sm text-gray-600 mb-4">
                        총 <span className="font-bold text-blue-600">{filteredSchools.length}개</span> 학교
              ...
              <div>
                {(() => {
                  ...
                  return (
                    <>
                      <div className="text-sm text-gray-600 mb-4">
                        총 <span className="font-bold text-blue-600">{filteredStudents.length}명</span> 학생
